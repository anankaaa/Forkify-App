...
return"function"!=typeof e||e.hasOwnProperty("prototype")});var L=Function.prototype.call;j=O?L.bind(L):function(){return L.apply(L,arguments)};var M={}.propertyIsEnumerable,x=Object.getOwnPropertyDescriptor;n=x&&!M.call({1:2},1)?function(e){var t=x(this,e);return!!t&&t.enumerable}:M;var P={};P=function(e,t){return{enumerable:!(1&e),configurable:!(2&e),writable:!(4&e),value:t}};var T={},I={},H={},q=Function.prototype,F=q.call,N=O&&q.bind.bind(F,F),A={},C=(H=O?N:function(e){return function(){return F.apply(e,arguments)}})({}.toString),D=H("".slice);A=function(e){return D(C(e),8,-1)};var R=Object,W=H("".split);// fallback for non-array-like ES3 and non-enumerable old V8 strings
I=$(function(){// throws an error in rhino, see https://github.com/mozilla/rhino/issues/346
// eslint-disable-next-line no-prototype-builtins -- safe
return!R("z").propertyIsEnumerable(0)})?function(e){return"String"===A(e)?W(e,""):R(e)}:R;var U={},G={};// we can't use just `it == null` since of `document.all` special case
// https://tc39.es/ecma262/#sec-IsHTMLDDA-internal-slot-aec
G=function(e){return null==e};var z=TypeError;// `RequireObjectCoercible` abstract operation
// https://tc39.es/ecma262/#sec-requireobjectcoercible
U=function(e){if(G(e))throw z("Can't call method on "+e);return e},T=function(e){return I(U(e))};var B={},Y={},J={},Q={},V={},K="object"==typeof document&&document.all,X=(V={all:K,IS_HTMLDDA:void 0===K&&void 0!==K}).all;// `IsCallable` abstract operation
...
!Symbol.sham&&eo&&eo<41}))&&!Symbol.sham&&"symbol"==typeof Symbol.iterator;var ef=Object;ee=en?function(e){return"symbol"==typeof e}:function(e){var t=et("Symbol");return Q(t)&&er(t.prototype,ef(e))};var ep={},eh={},eg={},ev=String;eg=function(e){try{return ev(e)}catch(e){return"Object"}};var ey=TypeError;// `Assert: IsCallable(argument) is true`
eh=function(e){if(Q(e))return e;throw ey(eg(e)+" is not a function")},// `GetMethod` abstract operation
// https://tc39.es/ecma262/#sec-getmethod
ep=function(e,t){var r=e[t];return G(r)?void 0:eh(r)};var em={},eb=TypeError;// `OrdinaryToPrimitive` abstract operation
// https://tc39.es/ecma262/#sec-ordinarytoprimitive
em=function(e,t){var r,n;if("string"===t&&Q(r=e.toString)&&!J(n=j(r,e))||Q(r=e.valueOf)&&!J(n=j(r,e))||"string"!==t&&Q(r=e.toString)&&!J(n=j(r,e)))return n;throw eb("Can't convert object to primitive value")};var e_={},ew={};ew=!1;var ek={},eE={},eS=Object.defineProperty;eE=function(e,t){try{eS(k,e,{value:t,configurable:!0,writable:!0})}catch(r){k[e]=t}return t};var e$="__core-js_shared__";ek=k[e$]||eE(e$,{}),(e_=function(e,t){return ek[e]||(ek[e]=void 0!==t?t:{})})("versions",[]).push({version:"3.32.1",mode:ew?"pure":"global",copyright:"\xa9 2014-2023 Denis Pushkarev (zloirock.ru)",license:"https://github.com/zloirock/core-js/blob/v3.32.1/LICENSE",source:"https://github.com/zloirock/core-js"});var ej={},eO={},eL=Object;// `ToObject` abstract operation
// https://tc39.es/ecma262/#sec-toobject
eO=function(e){return eL(U(e))};var eM=H({}.hasOwnProperty);// `HasOwnProperty` abstract operation
// https://tc39.es/ecma262/#sec-hasownproperty
// eslint-disable-next-line es/no-object-hasown -- safe
ej=Object.hasOwn||function(e,t){return eM(eO(e),t)};var ex={},eP=0,eT=Math.random(),eI=H(1..toString);ex=function(e){return"Symbol("+(void 0===e?"":e)+")_"+eI(++eP+eT,36)};var eH=k.Symbol,eq=e_("wks"),eF=en?eH.for||eH:eH&&eH.withoutSetter||ex,eN=TypeError,eA=(ej(eq,e="toPrimitive")||(eq[e]=ei&&ej(eH,e)?eH[e]:eF("Symbol."+e)),eq[e]);// `ToPrimitive` abstract operation
// https://tc39.es/ecma262/#sec-toprimitive
Y=function(e,t){if(!J(e)||ee(e))return e;var r,n=ep(e,eA);if(n){if(void 0===t&&(t="default"),r=j(n,e,t),!J(r)||ee(r))return r;throw eN("Can't convert object to primitive value")}return void 0===t&&(t="number"),em(e,t)},// `ToPropertyKey` abstract operation
// https://tc39.es/ecma262/#sec-topropertykey
B=function(e){var t=Y(e,"string");return ee(t)?t:t+""};var eC={},eD={},eR=k.document,eW=J(eR)&&J(eR.createElement);eD=function(e){return eW?eR.createElement(e):{}},// Thanks to IE8 for its funny defineProperty
...
var eU=Object.getOwnPropertyDescriptor;r=S?eU:function(e,t){if(e=T(e),t=B(t),eC)try{return eU(e,t)}catch(e){}if(ej(e,t))return P(!j(n,e,t),e[t])};var eG={},ez={};// V8 ~ Chrome 36-
// https://bugs.chromium.org/p/v8/issues/detail?id=3334
ez=S&&$(function(){// eslint-disable-next-line es/no-object-defineproperty -- required for testing
return 42!==Object.defineProperty(function(){},"prototype",{value:42,writable:!1}).prototype});var eB={},eY=String,eJ=TypeError;// `Assert: Type(argument) is Object`
eB=function(e){if(J(e))return e;throw eJ(eY(e)+" is not an object")};var eQ=TypeError,eV=Object.defineProperty,eK=Object.getOwnPropertyDescriptor,eX="enumerable",eZ="configurable",e0="writable";a=S?ez?function(e,t,r){if(eB(e),t=B(t),eB(r),"function"==typeof e&&"prototype"===t&&"value"in r&&e0 in r&&!r[e0]){var n=eK(e,t);n&&n[e0]&&(e[t]=r.value,r={configurable:eZ in r?r[eZ]:n[eZ],enumerable:eX in r?r[eX]:n[eX],writable:!1})}return eV(e,t,r)}:eV:function(e,t,r){if(eB(e),t=B(t),eB(r),eC)try{return eV(e,t,r)}catch(e){}if("get"in r||"set"in r)throw eQ("Accessors not supported");return"value"in r&&(e[t]=r.value),e},eG=S?function(e,t,r){return a(e,t,P(1,r))}:function(e,t,r){return e[t]=r,e};var e1={},e9={},e2=Function.prototype,e3=S&&Object.getOwnPropertyDescriptor,e4=ej(e2,"name")&&(!S||S&&e3(e2,"name").configurable),e7={},e5=H(Function.toString);Q(ek.inspectSource)||(ek.inspectSource=function(e){return e5(e)}),e7=ek.inspectSource;var e8={},e6={},te=k.WeakMap;e6=Q(te)&&/native code/.test(String(te));var tt={},tr=e_("keys");tt=function(e){return tr[e]||(tr[e]=ex(e))};var tn={};tn={};var ti="Object already initialized",to=k.TypeError,ta=k.WeakMap;if(e6||ek.state){var ts=ek.state||(ek.state=new ta);/* eslint-disable no-self-assign -- prototype methods protection */ts.get=ts.get,ts.has=ts.has,ts.set=ts.set,/* eslint-enable no-self-assign -- prototype methods protection */s=function(e,t){if(ts.has(e))throw to(ti);return t.facade=e,ts.set(e,t),t},c=function(e){return ts.get(e)||{}},u=function(e){return ts.has(e)}}else{var tc=tt("state");tn[tc]=!0,s=function(e,t){if(ej(e,tc))throw to(ti);return t.facade=e,eG(e,tc,t),t},c=function(e){return ej(e,tc)?e[tc]:{}},u=function(e){return ej(e,tc)}}var tu=(e8={set:s,get:c,has:u,enforce:function(e){return u(e)?c(e):s(e,{})},getterFor:function(e){return function(t){var r;if(!J(t)||(r=c(t)).type!==e)throw to("Incompatible receiver, "+e+" required");return r}}}).enforce,tl=e8.get,td=String,tf=Object.defineProperty,tp=H("".slice),th=H("".replace),tg=H([].join),tv=S&&!$(function(){return 8!==tf(function(){},"length",{value:8}).length}),ty=String(String).split("String"),tm=e9=function(e,t,r){"Symbol("===tp(td(t),0,7)&&(t="["+th(td(t),/^Symbol\(([^)]*)\)/,"$1")+"]"),r&&r.getter&&(t="get "+t),r&&r.setter&&(t="set "+t),(!ej(e,"name")||e4&&e.name!==t)&&(S?tf(e,"name",{value:t,configurable:!0}):e.name=t),tv&&r&&ej(r,"arity")&&e.length!==r.arity&&tf(e,"length",{value:r.arity});try{r&&ej(r,"constructor")&&r.constructor?S&&tf(e,"prototype",{writable:!1}):e.prototype&&(e.prototype=void 0)}catch(e){}var n=tu(e);return ej(n,"source")||(n.source=tg(ty,"string"==typeof t?t:"")),e};// add fake Function#toString for correct work wrapped methods / constructors with methods like LoDash isNative
// eslint-disable-next-line no-extend-native -- required
Function.prototype.toString=tm(function(){return Q(this)&&tl(this).source||e7(this)},"toString"),e1=function(e,t,r,n){n||(n={});var i=n.enumerable,o=void 0!==n.name?n.name:t;if(Q(r)&&e9(r,o,n),n.global)i?e[t]=r:eE(t,r);else{try{n.unsafe?e[t]&&(i=!0):delete e[t]}catch(e){}i?e[t]=r:a(e,t,{value:r,enumerable:!1,configurable:!n.nonConfigurable,writable:!n.nonWritable})}return e};var tb={},t_={},tw={},tk={},tE={},tS={},t$=Math.ceil,tj=Math.floor;// `Math.trunc` method
...
tk=function(e,t){var r=tE(e);return r<0?tO(r+t,0):tL(r,t)};var tM={},tx={},tP=Math.min;// `ToLength` abstract operation
// https://tc39.es/ecma262/#sec-tolength
tx=function(e){return e>0?tP(tE(e),9007199254740991):0;// 2 ** 53 - 1 == 9007199254740991
},// `LengthOfArrayLike` abstract operation
// https://tc39.es/ecma262/#sec-lengthofarraylike
tM=function(e){return tx(e.length)};// `Array.prototype.{ indexOf, includes }` methods implementation
var tT=function(e){return function(t,r,n){var i,o=T(t),a=tM(o),s=tk(n,a);// Array#includes uses SameValueZero equality algorithm
...
indexOf:tT(!1)}.indexOf,tH=H([].push);tw=function(e,t){var r,n=T(e),i=0,o=[];for(r in n)!ej(tn,r)&&ej(n,r)&&tH(o,r);// Don't enum bug & hidden keys
...
t_=et("Reflect","ownKeys")||function(e){var t=l(eB(e));return d?tF(t,d(e)):t},tb=function(e,t,n){for(var i=t_(t),o=0;o<i.length;o++){var s=i[o];ej(e,s)||n&&ej(n,s)||a(e,s,r(t,s))}};var tN={},tA=/#|\.prototype\./,tC=function(e,t){var r=tR[tD(e)];return r===tU||r!==tW&&(Q(t)?$(t):!!t)},tD=tC.normalize=function(e){return String(e).replace(tA,".").toLowerCase()},tR=tC.data={},tW=tC.NATIVE="N",tU=tC.POLYFILL="P";tN=tC,/*
...
if(a=t[i],o=e.dontCallGetSet?(s=r(n,i))&&s.value:n[i],!tN(u?i:c+(l?".":"#")+i,e.forced)&&void 0!==o){if(typeof a==typeof o)continue;tb(a,o)}(e.sham||o&&o.sham)&&eG(a,"sham",!0),e1(n,i,a,e)}};var tG={},tz={},tB=Function.prototype,tY=tB.apply,tJ=tB.call;// eslint-disable-next-line es/no-reflect -- safe
tz="object"==typeof Reflect&&Reflect.apply||(O?tJ.bind(tY):function(){return tJ.apply(tY,arguments)});var tQ={},tV={},tK=(tV=function(e){// Nashorn bug:
//   https://github.com/zloirock/core-js/issues/1128
//   https://github.com/zloirock/core-js/issues/1130
if("Function"===A(e))return H(e)})(tV.bind);// optional / simple context binding
tQ=function(e,t){return eh(e),void 0===t?e:O?tK(e,t):function(){return e.apply(t,arguments)}};var tX={};tX=et("document","documentElement");var tZ={};tZ=H([].slice);var t0={},t1=TypeError;t0=function(e,t){if(e<t)throw t1("Not enough arguments");return e};var t9={};// eslint-disable-next-line redos/no-vulnerable -- safe
t9=/(?:ipad|iphone|ipod).*applewebkit/i.test(ea);var t2={};t2="process"===A(k.process);var t3=k.setImmediate,t4=k.clearImmediate,t7=k.process,t5=k.Dispatch,t8=k.Function,t6=k.MessageChannel,re=k.String,rt=0,rr={},rn="onreadystatechange";$(function(){// Deno throws a ReferenceError on `location` access without `--location` flag
f=k.location});var ri=function(e){if(ej(rr,e)){var t=rr[e];delete rr[e],t()}},ro=function(e){return function(){ri(e)}},ra=function(e){ri(e.data)},rs=function(e){// old engines have not location.origin
k.postMessage(re(e),f.protocol+"//"+f.host)};t3&&t4||(t3=function(e){t0(arguments.length,1);var t=Q(e)?e:t8(e),r=tZ(arguments,1);return rr[++rt]=function(){tz(t,void 0,r)},p(rt),rt},t4=function(e){delete rr[e]},t2?p=function(e){t7.nextTick(ro(e))}:t5&&t5.now?p=function(e){t5.now(ro(e))}:t6&&!t9?(g=(h=new t6).port2,h.port1.onmessage=ra,p=tQ(g.postMessage,g)):k.addEventListener&&Q(k.postMessage)&&!k.importScripts&&f&&"file:"!==f.protocol&&!$(rs)?(p=rs,k.addEventListener("message",ra,!1)):p=rn in eD("script")?function(e){tX.appendChild(eD("script"))[rn]=function(){tX.removeChild(this),ri(e)}}:function(e){setTimeout(ro(e),0)});var rc=(tG={set:t3,clear:t4}).clear;// `clearImmediate` method
// http://w3c.github.io/setImmediate/#si-clearImmediate
w({global:!0,bind:!0,enumerable:!0,forced:k.clearImmediate!==rc},{clearImmediate:rc});var ru=tG.set,rl={},rd={};/* global Bun -- Deno case */rd="function"==typeof Bun&&Bun&&"string"==typeof Bun.version;var rf=k.Function,rp=/MSIE .\./.test(ea)||rd&&((t=k.Bun.version.split(".")).length<3||"0"===t[0]&&(t[1]<3||"3"===t[1]&&"0"===t[2]));// IE9- / Bun 0.3.0- setTimeout / setInterval / setImmediate additional parameters fix
// https://html.spec.whatwg.org/multipage/timers-and-user-prompts.html#timers
// https://github.com/oven-sh/bun/issues/1633
rl=function(e,t){var r=t?2:1;return rp?function(n,i/* , ...arguments */){var o=t0(arguments.length,1)>r,a=Q(n)?n:rf(n),s=o?tZ(arguments,r):[],c=o?function(){tz(a,this,s)}:a;return t?e(c,i):e(c)}:e};// https://github.com/oven-sh/bun/issues/1633
...
(this.arg=t),g}},e}({});try{regeneratorRuntime=rg}catch(e){"object"==typeof globalThis?globalThis.regeneratorRuntime=rg:Function("r","regeneratorRuntime = r")(rg)}const rv="https://forkify-api.herokuapp.com/api/v2/recipes/",ry="4971149b-df7f-436e-9897-4e31524023bf",rm=async function(e,t){try{let r=t?fetch(e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}):fetch(e),n=await Promise.race([r,new Promise(function(e,t){setTimeout(function(){t(Error("Request took too long! Timeout after 10 second"))},1e4)})]),i=await n.json();if(!n.ok)throw Error(`${i.message} (${n.status})`);return i}catch(e){throw e}},rb={recipe:{},search:{query:"",results:[],page:1,resultsPerPage:10},bookmarks:[]},r_=function(e){let{recipe:t}=e.data;return{id:t.id,title:t.title,publisher:t.publisher,sourceUrl:t.source_url,image:t.image_url,servings:t.servings,cookingTime:t.cooking_time,ingredients:t.ingredients,...t.key&&{key:t.key}}},rw=async function(e){try{let t=await rm(`${rv}${e}?key=${ry}`);rb.recipe=r_(t),rb.bookmarks.some(t=>t.id===e)?rb.recipe.bookmarked=!0:rb.recipe.bookmarked=!1,console.log(rb.recipe)}catch(e){throw(// Temp error handling
console.error(`${e} 💥💥💥💥`),e)}},rk=async function(e){try{rb.search.query=e;let t=await rm(`${rv}?search=${e}&key=${ry}`);console.log(t),rb.search.results=t.data.recipes.map(e=>({id:e.id,title:e.title,publisher:e.publisher,image:e.image_url,...e.key&&{key:e.key}})),rb.search.page=1}catch(e){throw console.error(`${e} 💥💥💥💥`),e}},rE=function(e=rb.search.page){return rb.search.page=e,rb.search.results.slice((e-1)*10,10*e)},rS=function(e){rb.recipe.ingredients.forEach(t=>{t.quantity=t.quantity*e/rb.recipe.servings;// newQt = oldQt * newServings / oldServings // 2 * 8 / 4 = 4
}),rb.recipe.servings=e},r$=function(){localStorage.setItem("bookmarks",JSON.stringify(rb.bookmarks))},rj=function(e){//add bookmark
rb.bookmarks.push(e),e.id===rb.recipe.id&&(rb.recipe.bookmarked=!0),r$()},rO=function(e){//delete bookmark
let t=rb.bookmarks.findIndex(t=>t.id===e);rb.bookmarks.splice(t,1),e===rb.recipe.id&&(rb.recipe.bookmarked=!1)};!function(){let e=localStorage.getItem("bookmarks");e&&(rb.bookmarks=JSON.parse(e))}();const rL=async function(e){try{let t=Object.entries(e).filter(e=>e[0].startsWith("ingredient")&&""!==e[1]).map(e=>{let t=e[1].split(",").map(e=>e.trim());// const ingArr = ing[1].replaceAll(' ', '').split(',');
if(3!==t.length)throw Error("Wrong ingredient fromat! Please use the correct format :)");let[r,n,i]=t;return{quantity:r?+r:null,unit:n,description:i}}),r={title:e.title,source_url:e.sourceUrl,image_url:e.image,publisher:e.publisher,cooking_time:+e.cookingTime,servings:+e.servings,ingredients:t},n=await rm(`${rv}?key=${ry}`,r);rb.recipe=r_(n),rj(rb.recipe)}catch(e){throw e}};var rM={};rM=new URL(_("27Lyk").resolve("5XmIc"),import.meta.url).toString();class rx{_data;/**
   ...
   */render(e,t=!0){if(!e||Array.isArray(e)&&0===e.length)return this.renderError();this._data=e;let r=this._generateMarkup();if(!t)return r;this._clear(),this._parentElement.insertAdjacentHTML("afterbegin",r)}update(e){this._data=e;let t=this._generateMarkup(),r=document.createRange().createContextualFragment(t),n=Array.from(r.querySelectorAll("*")),i=Array.from(this._parentElement.querySelectorAll("*"));n.forEach((e,t)=>{let r=i[t];e.isEqualNode(r)||e.firstChild?.nodeValue.trim()===""||(r.textContent=e.textContent),e.isEqualNode(r)||Array.from(e.attributes).forEach(e=>r.setAttribute(e.name,e.value))})}_clear(){this._parentElement.innerHTML=""}renderSpinner(){let e=`
      <div class="spinner">
        <svg>
          <use href="${/*@__PURE__*/y(rM)}#icon-loader"></use>
        </svg>
      </div>
      ...
      <div class="error">
        <div>
          <svg>
            <use href="${/*@__PURE__*/y(rM)}#icon-alert-triangle"></use>
          </svg>
        </div>
        <p>${e}</p>
      </div>
      ...
      <div class="message">
        <div>
          <svg>
            <use href="${/*@__PURE__*/y(rM)}#icon-alert-smile"></use>
          </svg>
        </div>
        <p>${e}</p>
      </div>
...
return rT(u,(c-1)*a,n,i,!0);//Further reduce the numerator and denominator.
...
}};class rI extends rx{_parentElement=document.querySelector(".recipe");_errorMessage="We could not find that recipe. Please try another one";_successMessage="Start by searching for a recipe or an ingredient. Have fun!";addHandlerRender(e){["hashchange","load"].forEach(t=>window.addEventListener(t,e))}addHandlerUpdateServings(e){this._parentElement.addEventListener("click",function(t){let r=t.target.closest(".btn--update-servings");if(!r)return;let{updateTo:n}=r.dataset;+n>0&&e(+n)})}addHandlerAddBookmark(e){this._parentElement.addEventListener("click",function(t){let r=t.target.closest(".btn--bookmark");r&&e()})}_generateMarkup(){return`
        ...
        <div class="recipe__details">
          <div class="recipe__info">
            <svg class="recipe__info-icon">
              <use href="${/*@__PURE__*/y(rM)}#icon-clock"></use>
            </svg>
          ...
          <div class="recipe__info">
            <svg class="recipe__info-icon">
              <use href="${/*@__PURE__*/y(rM)}#icon-users"></use>
            </svg>
            ...
            <div class="recipe__info-buttons">
              <button class="btn--tiny btn--update-servings" data-update-to="${this._data.servings-1}">
                <svg>
                  <use href="${/*@__PURE__*/y(rM)}#icon-minus-circle"></use>
                </svg>
              </button>
              <button class="btn--tiny btn--update-servings" data-update-to="${this._data.servings+1}">
                <svg>
                  <use href="${/*@__PURE__*/y(rM)}#icon-plus-circle"></use>
                </svg>
              </button>
            </div>
          </div>
          ...
          <div class="recipe__user-generated ${this._data.key?"":"hidden"}">
            <svg>
              <use href="${/*@__PURE__*/y(rM)}#icon-user"></use>
            </svg>
          </div>
          <button class="btn--round btn--bookmark">
            <svg class="">
              <use href="${/*@__PURE__*/y(rM)}#icon-bookmark${this._data.bookmarked?"-fill":""}"></use>
            </svg>
          </button>
        </div>
        ...
        <div class="recipe__directions">
          ...
          >
            ...
            <svg class="search__icon">
              <use href="${/*@__PURE__*/y(rM)}#icon-arrow-right"></use>
            </svg>
          </a>
        </div>
    `}_generateMarkupIngredient(e){return`
      <li class="recipe__ingredient">
        <svg class="recipe__icon">
          <use href="${/*@__PURE__*/y(rM)}#icon-check"></use>
        </svg>
        <div class="recipe__quantity">${e.quantity?/*@__PURE__*/y(rP)(e.quantity).toString():""}</div>
        <div class="recipe__description">
          <span class="recipe__unit">${e.unit}</span>
          ${e.description}
        </div>
      </li>
      `}}var rH=new rI;class rq{_parentEl=document.querySelector(".search");getQuery(){let e=this._parentEl.querySelector(".search__field").value;return this._clearInput(),e}_clearInput(){return this._parentEl.querySelector(".search__field").value=""}addHandlerSearch(e){this._parentEl.addEventListener("submit",function(t){t.preventDefault(),e()})}}var rF=new rq,rN=new class extends rx{_parentElement="";_generateMarkup(){let e=window.location.hash.slice(1);return`
      <li class="preview">
    ...
    `}};class rA extends rx{_parentElement=document.querySelector(".results");_errorMessage="No recipes found for your query! Please try again ;)";_successMessage="Start by searching for a recipe or an ingredient. Have fun!";_generateMarkup(){return this._data.map(e=>rN.render(e,!1)).join("")}}var rC=new rA;class rD extends rx{_parentElement=document.querySelector(".pagination");addHandlerClick(e){this._parentElement.addEventListener("click",function(t){let r=t.target.closest(".btn--inline");if(!r)return;let n=+r.dataset.goto;e(n)})}_generateMarkup(){let e=this._data.page,t=Math.ceil(this._data.results.length/this._data.resultsPerPage);return(//page 1, there are other pages
1===e&&t>1?`
      ...
      <button data-goto="${e-1}" class="btn--inline pagination__btn--prev">
        <svg class="search__icon">
          <use href="${/*@__PURE__*/y(rM)}#icon-arrow-left"></use>
        </svg>
        <span>Page ${e-1}</span>
      </button>
      `:e<t?`
      ...
      <button data-goto="${e+1}" class="btn--inline pagination__btn--next">
        ...
        `:"")}}var rR=new rD;class rW extends rx{_parentElement=document.querySelector(".bookmarks__list");_errorMessage="No bookmarks yet. Find a nice recipe and bookmark it ;)";_message="";addHandlerRender(e){window.addEventListener("load",e)}_generateMarkup(){return this._data.map(e=>rN.render(e,!1)).join("")}}var rU=new rW;class rG extends rx{_parentElement=document.querySelector(".upload");_successMessage="Recipe was successfully uploaded :)";_window=document.querySelector(".add-recipe-window");_overlay=document.querySelector(".overlay");_btnOpen=document.querySelector(".nav__btn--add-recipe");_btnClose=document.querySelector(".btn--close-modal");constructor(){super(),this._addHandlerShowWindow(),this._addHandlerHideWindow()}toggleWindow(){this._overlay.classList.toggle("hidden"),this._window.classList.toggle("hidden")}_addHandlerShowWindow(){this._btnOpen.addEventListener("click",this.toggleWindow.bind(this))}_addHandlerHideWindow(){this._btnClose.addEventListener("click",this.toggleWindow.bind(this)),this._overlay.addEventListener("click",this.toggleWindow.bind(this))}addHandlerUpload(e){this._parentElement.addEventListener("submit",function(t){t.preventDefault();let r=[...new FormData(this)],n=Object.fromEntries(r);e(n)})}_generateMarkup(){}}var rz=new rG;//API: https://forkify-api.herokuapp.com/v2
///////////////////////////////////////
const rB=async function(){try{let e=window.location.hash.slice(1);//using guard if no id
if(!e)return;rH.renderSpinner(),rC.update(rE()),rU.update(rb.bookmarks),///////////////
//Loading recipe
await rw(e),rH.render(rb.recipe)}catch(e){rH.renderError()}},rY=async function(){try{rC.renderSpinner();// get search query
let e=rF.getQuery();if(!e)return;//load search results
await rk(e),rC.render(rE()),rR.render(rb.search)}catch(e){console.error(e)}},rJ=async function(e){try{rz.renderSpinner(),// Upload the new recipe data
await rL(e),rH.render(rb.recipe),rz.renderMessage(),rU.render(rb.bookmarks),// Change ID in URL
window.history.pushState(null,"",`#${rb.recipe.id}`),// Close form window
setTimeout(function(){rz.toggleWindow()},2500)}catch(e){console.error("\uD83D\uDCA5",e),rz.renderError(e.message)}};rU.addHandlerRender(function(){rU.render(rb.bookmarks)}),rH.addHandlerRender(rB),rF.addHandlerSearch(rY),rR.addHandlerClick(function(e){rC.render(rE(e)),rR.render(rb.search)}),rH.addHandlerUpdateServings(function(e){// Update the recipe servings (in state)
rS(e),rH.update(rb.recipe)}),rH.addHandlerAddBookmark(function(){rb.recipe.bookmarked?rO(rb.recipe.id):rj(rb.recipe),rH.update(rb.recipe),rU.render(rb.bookmarks)}),rz.addHandlerUpload(rJ);/* extra:
...
*///# sourceMappingURL=index.f4920331.js.map
